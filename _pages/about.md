...
.students-section {
  ...
  border-radius: 18px;
  backgrand: linear-gradient(180deg,#fff 0%,#f8fbff 100%);
...
.student-tag.first-author {
  color: #fff;
  font-weight: 900;
  backgrand: linear-gradient(135deg, #FE667B 0%, #6aa9ff 100%);
...
.student-group-title:after {
  ...
  flex: 1;
  height: 1px;
  backgrand: linear-gradient(90deg,rgba(1,47,99,.18),transparent);
}
.student-grid {
  display: grid;
...
.student-card:before {
  ...
  backgrand: linear-gradient(180deg,#FE667B,#6aa9ff);
}
.student-card:hover {
...
.open-science-note {
  ...
  border-radius: 12px;
  backgrand: linear-gradient(180deg, #f8fbff 0%, #ffffff 100%);
...
.research-lane-label.orange { color: #a54816; backgrand: #fff0e6; border: 1px dashed #ffc7a0; }
.research-lane-label.blue { color: #174f91; backgrand: #eaf4ff; border: 1px dashed #a9cff7; }
.research-lane {
  display: grid;
...
.research-node.orange { backgrand: linear-gradient(180deg, #fffaf6, #ffffff); }
.research-node.blue { backgrand: linear-gradient(180deg, #f6fbff, #ffffff); }
...
.node-paper-link {
  ...
  backgrand: rgba(254,102,123,0.08);
...
.roadmap-back-btn {
  ...
  backgrand: linear-gradient(135deg, #012F63 0%, #2f6fb3 100%);
  color: #fff !important;
  font-size: 0.86rem;
  font-weight: 800;
  text-decoration: none !important;
...
.research-arrow {
  ...
  backgrand: linear-gradient(90deg, #ffd6b5 0%, #ffd3dc 42%, #9ec7ff 100%);
  display: flex;
  align-items: center;
...
.opensource-section {
  ...
  border-radius: 18px;
  border: 1px solid rgba(1,47,99,0.08);
  backgrand: linear-gradient(180deg, #ffffff 0%, #f8fbff 100%);
  box-shadow: 0 10px 30px rgba(1,47,99,0.06);
}
.section-kicker {
  display: inline-flex;
...
.news-grid::-webkit-scrollbar-thumb {
  backgrand: linear-gradient(180deg, #FE667B 0%, #6aa9ff 100%);
  border-radius: 999px;
}
...
.award-ribbon span {
  ...
  border-radius: 999px;
  color: #7a4b00;
  backgrand: linear-gradient(135deg, #fff7d6, #ffe5a3);
...
.filter-btn:hover {
  backgrand-color: #eaecef;
  color: #24292e;
}
.filter-btn.active {
  backgrand: linear-gradient(135deg, #38ef7d, #11998e);
  color: white;
  border-color: transparent;
...
.paper-box {
  ...
  backgrand: linear-gradient(#ffffff, #ffffff) padding-box,
...
<!-- I am a Ph.D. student in Artificial Intelligence at [Shandong University](https://www.sdu.edu.cn), under the supervision of Prof. [Liqiang Nie](https://liqiangnie.github.io/index.html). In 2023, I received my Bachelor's degree in Data Science and Big Data Technology from [Shandong University](https://www.sdu.edu.cn). -->
...
<div class="language-switcher" id="research-language-switcher">
  ...
  <div class="lang-panel active" data-lang-panel="en" role="tabpanel">
    <div class="research-intro">
      ...
      <p>In my research, I systematically explore the main theme of <strong>Multimodal understanding, retrieval, and generation</strong>. As first author or Project Leader, I have published more than ten papers in CCF-A international conferences and journals, including <strong>CVPR, ACL, AAAI, ACM MM, IEEE TIP, and IEEE TKDE</strong>. I have also led team to won champion, runner-up, and third-place awards multiple times in Grand Challenges at top-tier conferences such as CVPR. Notable achievements include CVPR 2026 VidLLMs Reasoned-Aware CoVR Challenge 1st Place Award, CVPR 2026 EgoVis HD-EPIC Challenge 1st Place Award, CVPR 2026 EgoVis EPIC-KITCHENS Multi-Instance Retrieval Challenge 1st Place Award, and SIGIR 2026 eCommerce Data Challenge 1st Place Award. In addition, I have long served as a PC Member for <strong>CVPR, ECCV, ICLR, NeurIPS, AAAI, ACM MM, and SIGIR</strong>, and as a reviewer for journals including <strong>IEEE TIP</strong> and <strong>IEEE TIFS</strong>.</p>
        <!-- I have also won champion, runner-up, and third-place awards multiple times in top-tier conference challenges such as CVPR. -->
  ...
  <div class="lang-panel" data-lang-panel="zh" role="tabpanel">
    <div class="research-intro">
      <p>欢迎来到我的主页！我目前是山东大学人工智能专业的博士生，师从 Prof. <a href="https://liqiangnie.github.io/index.html">Liqiang Nie</a>。在此之前，我于2023年在山东大学获得数据科学与大数据技术专业学士学位。我的研究兴趣主要聚焦于<strong>多模态大模型、鲁棒表征学习、可信AI</strong>。</p>
      <p>在科研探索中，我紧密围绕“<strong>多模态理解、检索与生成</strong>”这一主线展开系统性研究，以第一作者/Project Leader身份在 <strong>CVPR、ACL、AAAI、ACM MM、IEEE TIP、IEEE TKDE</strong> 等CCF A类国际会议与期刊上发表论文10余篇，并多次带领团队获得CVPR等顶会挑战赛的冠、亚、季军，如CVPR 2026 VidLLMs Reasoned-Aware CoVR Challenge 1st Place Award, CVPR 2026 EgoVis HD-EPIC Challenge 1st Place Award, CVPR 2026 EgoVis EPIC-KITCHENS Multi-Instance Retrieval Challenge 1st Place Award 和 SIGIR 2026 eCommerce Data Challenge 1st Place Award等。此外，我长期担任 <strong>CVPR、ECCV、ICLR、NeurIPS、AAAI、ACM MM、SIGIR</strong> 等会议的PC Member和 <strong>IEEE TIP、IEEE TIFS</strong> 等期刊的审稿人。</p>
...
<div class="opensource-section" id="open-source-projects">
  ...
  <div class="opensource-grid" id="opensource-grid">
    ...
    <div class="opensource-card">
      ...
      <div class="opensource-card-links">        <a href="https://arxiv.org/abs/2606.04604" target="_blank" title="Open COMBINER paper"><span class="i18n-en-inline">Paper</span><span class="i18n-zh-inline">论文</span></a>
...
<section class="students-section">
  ...
  <p class="students-intro i18n-en">
    ...
    students I have supervised, including their backgrands, publications, and awards.
  </p>
    ...
    <div class="student-grid">
      <article class="student-card">
        ...
        <div class="student-tags">
          ...
          <span class="student-tag award">Grand Challenge 1st @ SIGIR’26</span>
    ...
    <div class="student-grid">
      ...
      <article class="student-card">
        ...
        <div class="student-tags">
          ...
          <span class="student-tag first-author">AAAI’25</span>
        </div>
        <span class="student-label">🎖 Awards</span>
        <div class="student-tags">
          <span class="student-tag award">CICAS Grand Prize</span>
      ...
      <article class="student-card">
        ...
        <span class="student-label">🎖 Awards</span>
        <div class="student-tags">
          <span class="student-tag award">Grand Challenge 1st @ CVPR’26 ×3</span>
          <span class="student-tag first-author">Grand Challenge 2nd @ ECCV’26</span>
          <span class="student-tag award">Grand Challenge 2nd @ CVPR’26 ×2</span>
          <span class="student-tag first-author">Grand Challenge 3rd @ CVPR’26</span>
          <span class="student-tag first-author">Grand Challenge 1st @ SIGIR’26</span>
...
<div class="student-group">
    ...
    <div class="student-grid">
      <article class="student-card">
        ...
        <span class="student-label">🎖 Awards</span>
        <div class="student-tags">
          <span class="student-tag award">Grand Challenge 2nd @ ECCV’26</span>
          <span class="student-tag award">CICAS Grand Prize</span>
        </div>
      </article>
      <article class="student-card">
