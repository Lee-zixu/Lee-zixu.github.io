...
<div class="language-switcher" id="research-language-switcher">
  ...
  <div class="lang-panel active" data-lang-panel="en" role="tabpanel">
    <div class="research-intro">
      <p>Welcome to my homepage! I am currently a Ph.D. student in Artificial Intelligence at <a href="https://www.sdu.edu.cn">Shandong University</a>, and I am honored to be advised by Prof. <a href="https://liqiangnie.github.io/index.html">Liqiang Nie</a>. Prior to this, I received my Bachelor's degree in Data Science and Big Data Technology from <a href="https://www.sdu.edu.cn">Shandong University</a> in 2023. My research interests mainly focus on <strong>World Model, Agent, Reinforcement Learning, and Information Retrieval</strong>.</p>
      <p>In my research, I systematically explore the main theme of <strong>Multimodal understanding, retrieval, and generation</strong>. As first author or Project Leader, I have published more than ten papers in CCF-A international conferences and journals, including <strong>CVPR, ACL, AAAI, ACM MM, IEEE TIP, and IEEE TKDE</strong>. I have also led team to won champion, runner-up, and third-place awards multiple times in Grand Challenges at top-tier conferences such as CVPR, ECCV, and SIGIR. Notable achievements include CVPR 2026 VidLLMs Reasoned-Aware CoVR Challenge 1st Place Award, CVPR 2026 EgoVis HD-EPIC Challenge 1st Place Award, CVPR 2026 EgoVis EPIC-KITCHENS Multi-Instance Retrieval Challenge 1st Place Award, and SIGIR 2026 eCommerce Data Challenge 1st Place Award. In addition, I have long served as a PC Member for <strong>CVPR, ECCV, ICLR, NeurIPS, AAAI, ACM MM, and SIGIR</strong>, and as a reviewer for journals including <strong>IEEE TIP</strong> and <strong>IEEE TIFS</strong>.</p>
  ...
  <div class="lang-panel" data-lang-panel="zh" role="tabpanel">
    <div class="research-intro">
      <p>欢迎来到我的主页！我目前是山东大学人工智能专业的博士生，师从 Prof. <a href="https://liqiangnie.github.io/index.html">Liqiang Nie</a>。在此之前，我于2023年在山东大学获得数据科学与大数据技术专业学士学位。我的研究兴趣主要聚焦于<strong>世界模型、智能体、强化学习和信息检索</strong>。</p>
      <p>在科研探索中，我紧密围绕“<strong>多模态理解、检索与生成</strong>”这一主线展开系统性研究，以第一作者/Project Leader身份在 <strong>CVPR、ACL、AAAI、ACM MM、IEEE TIP、IEEE TKDE</strong> 等CCF A类国际会议与期刊上发表论文10余篇，并多次带领团队获得CVPR、ECCV、SIGIR等顶会挑战赛的冠、亚、季军，如CVPR 2026 VidLLMs Reasoned-Aware CoVR Challenge 1st Place Award, CVPR 2026 EgoVis HD-EPIC Challenge 1st Place Award, CVPR 2026 EgoVis EPIC-KITCHENS Multi-Instance Retrieval Challenge 1st Place Award 和 SIGIR 2026 eCommerce Data Challenge 1st Place Award等。此外，我长期担任 <strong>CVPR、ECCV、ICLR、NeurIPS、AAAI、ACM MM、SIGIR</strong> 等会议的PC Member和 <strong>IEEE TIP、IEEE TIFS</strong> 等期刊的审稿人。</p>
...
<ul class="i18n-zh">
  ...
  <li>期刊审稿人：IEEE TIP, IEEE TIFS, ACM ToMM, PR, Journal of Software (软件学报)</li>
</ul>
