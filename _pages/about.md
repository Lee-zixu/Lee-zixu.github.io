...
<div class="language-switcher" id="research-language-switcher">
  ...
  <div class="lang-panel" data-lang-panel="zh" role="tabpanel">
    <div class="research-intro">
      ...
      <p>在科研探索中，我紧密围绕“<strong>多模态理解、检索与生成</strong>”这一主线展开系统性研究，以第一作者/Project Leader身份在 <strong>CVPR、ACL、AAAI、ACM MM、IEEE TIP、IEEE TKDE</strong> 等CCF A类国际会议与期刊上发表论文10余篇，并多次获得CVPR等顶会挑战赛的冠、亚、季军。此外，我长期担任 <strong>CVPR、ECCV、ICLR、NeurIPS、AAAI、ACM MM、SIGIR</strong> 等会议的PC Member和 <strong>IEEE TIP、IEEE TIFS</strong> 等期刊的审稿人。</p>
    ...
    <div class="student-grid">
      <article class="student-card">
        ...
        <div class="student-tags">
          ...
          <span class="student-tag first-author">AAAI’26</span></span>
